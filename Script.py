class script(object):
    START_TXT = """ʜᴇʏ{} ʙᴀʙʏ 😘
✪ ɪ ᴀᴍ  ᴀʏᴇsʜᴀ xᴛʀɪ.
✪ᴀ ᴘᴏᴡᴇʀғᴜʟʟ ᴍᴏᴠɪᴇ ʙᴏᴛ ᴡɪᴛʜ ᴜsᴇғᴜʟʟ ғᴇᴀᴛᴜʀᴇ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀs.
✪ ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴀʟʟ ᴍᴏᴠɪᴇs ᴀɴᴅ ᴡᴇʙsᴇʀɪᴇs ᴊᴜsᴛ ᴡʀɪᴛᴇ ᴛʜᴇ ɴᴀᴍᴇ ᴡɪᴛʜ ʏᴇᴀʀ.\n\n➥ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏ ᴄʜᴇᴄᴋ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ʙᴀʙʏ 💞"""
    HELP_TXT = """ʜᴇʏ {}
ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ᴍᴇɴᴜ.

◈ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ᴀʙᴏᴜᴛ sᴘᴇᴄɪғɪᴄs ᴄᴏᴍᴍᴀɴᴅ."""
    ABOUT_TXT = """<b>🤖 𝖡ᴏᴛ ɴᴀᴍᴇ: ᴀʏᴇsʜᴀ xᴛʀɪ</b>

<b>👨‍💻 𝖣ᴇᴠᴇʟᴏᴘᴇʀ: <a href=https://t.me/marcusxbot>Ξ𐌌ΛᏒꉓꀎꌗ</a></b>

<b>📚 𝖥ʀᴀᴍᴇᴡᴏʀᴋ: ᴘʏʀᴏɢʀᴀᴍ</b>

<b>📝 𝖫ᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 3</b>

<b>🛑 Dᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ</b>

<b>📡 𝖧ᴏsᴛᴇᴅ ᴏɴ : ʜᴇʀᴏᴋᴜ</b>

<b>👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ: <a href=https://t.me/request_movie2>ᴍᴏᴠɪᴇs ɢʀᴏᴜᴘ</a></b>"""
    DONATION_TXT = """ɴᴏ ɴᴇᴇᴅ"""
    PROMOTION_TXT = """@marcusxbot""" 
...
5. /luck or /cownd - 𝚂𝙿𝙸𝙽 𝙰𝙽𝙳 𝚃𝚁𝚈 𝚈𝙾𝚄𝚁 𝙻𝚄𝙲𝙺"""
    DEPLOY_TXT = """Coming soon"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and ᗩᒍᗩ᙭  will respond whenever a keyword is found the message

<b>NOTE:</b>
1. Ayesha should have admin privillage.
...
<b>›› 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 <a href=https://t.me/Marcusxbot>Marcus</a></b>"""
...
-Ayesha  Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. Ayesha supports buttons with any telegram media type.
...
<b>NOTE:</b>
these are the extra features of Ayesha xtri 
...
➛𝖤𝗑𝖺𝗆𝗉𝗅𝖾:
<code>/short https://youtu.be/kB9TkCbbbs8cX0</code>"""
...
• 𝘌𝘹𝘢𝘮𝘱𝘭𝘦:
<code>/mp4 https://youtu.be/kB9TkCs8cbbX0</code>
<code>/video https://youtu.be/kB9TkCs8vvbcX0</code>"""
...
• 𝘌𝘹𝘢𝘮𝘱𝘭𝘦
<code>/ytthumb https://youtu.be/UyzJ9KEhhoU0w</code>"""
